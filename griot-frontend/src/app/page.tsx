          ...
          <div className="text-center">
            ...
            <div className="mx-auto max-w-3xl">
              <p className="text-lg text-gray-700 dark:text-gray-300 sm:text-xl">
                Transform your imagination into stunning manga stories with the
                power of AI. Create personalized manga content tailored to your
                preferences, from epic adventures to heartwarming tales.
              </p>
            </div>
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="relative rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg ring-1 ring-gray-200 dark:ring-gray-700">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-300">
                Advanced AI technology creates unique manga stories and artwork
                based on your preferences and chosen themes.
              </p>
            </div>
            ...
            <div className="relative rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg ring-1 ring-gray-200 dark:ring-gray-700">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-300">
                Tailor your manga experience with custom preferences for genres,
                art styles, and themes that match your taste.
              </p>
            </div>
            ...
            <div className="relative rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-lg ring-1 ring-gray-200 dark:ring-gray-700">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-300">
                ...
                backgrounds, and visual effects that bring your stories to life.
              </p>
            </div>
